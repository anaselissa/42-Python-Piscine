...
![Topic](https://img.shields.io/badge/Topic-Data_Validation-red.svg)
![Topic](https://img.shields.io/badge/Topic-Pydantic-brightgreen.svg)
...
* **Nested Object Validation:** Embedding models within models (e.g., a `list[CrewMember]` inside a `SpaceMission`). The validation engine aggregates child data to enforce parent-level constraints (e.g., ensuring a mission has at least one Commander).

---

## 📐 Architecture: Pydantic Validation Lifecycle
